...
class Feature(Expression):
    ...
    def _load_internal(self, instrument, start_index, end_index, freq):
        ...
        ret= instrument[str(self)]
        ret = ret.loc[start_index:end_index]
        #ret = ret.compute()
        return ret
...
class If(ExpressionOps):
    ...
    def _load_internal(self, instrument, start_index, end_index, freq):
        ...
        if isinstance(self.feature_right, Expression):
            ...
            series_right = self.feature_right
        series = pd.Series(series_left.where(series_cond,series_right), index=series_cond.index)
        return series
...
class RefBTC(Rolling):
    ...
    def __init__(self, feature, N):
        super(RefBTC, self).__init__(feature, N, "refbtc")

    def _load_internal(self, instrument, start_index, end_index, freq):
        

        instrument = cache("BTCBUSD.parquet")
        series = self.feature.load(instrument, start_index, end_index, freq)
        # N = 0, return first day
        if series.empty:
            return series  # Pandas bug, see: https://github.com/pandas-dev/pandas/issues/21049
...
class RefETH(Rolling):
    ...
    def __init__(self, feature, N):
        super(RefETH, self).__init__(feature, N, "refeth")

    def _load_internal(self, instrument, start_index, end_index, freq):
        
        instrument = cache("ETHBUSD.parquet")
        series = self.feature.load(instrument, start_index, end_index, freq)
        # N = 0, return first day
        if series.empty:
            return series  # Pandas bug, see: https://github.com/pandas-dev/pandas/issues/21049
...
class DeltaBTC(Rolling):
    ...
    def __init__(self, feature, N):
        super(DeltaBTC, self).__init__(feature, N, "deltabtc")
...
class DeltaETH(Rolling):
    ...
    def __init__(self, feature, N):
        super(DeltaETH, self).__init__(feature, N, "deltaeth")
...
class SlopeBTC(Rolling):
    ...
    def __init__(self, feature, N):
        super(SlopeBTC, self).__init__(feature, N, "slopebtc")
...
class SlopeETH(Rolling):
    ...
    def __init__(self, feature, N):
        super(SlopeETH, self).__init__(feature, N, "slopeeth")
...
class PairRollingBTC(ExpressionOps):
    """Pair Rolling Operator
    ...
    def _load_internal(self, instrument, start_index, end_index, freq):
        ...
        if len(series_left) < len(series_right):
            series_right = series_right.reindex(index=series_left.index)
    ...
    def get_extended_window_size(self):
        if self.N == 0:
            ...
            rl, rr = self.feature_right.get_extended_window_size()
            return max(ll, rl) + self.N - 1, max(lr, rr)
class PairRollingETH(ExpressionOps):
    """Pair Rolling Operator
...
class CorrBTC(PairRollingBTC):
    ...
    def __init__(self, feature_left, feature_right, N):
        super(CorrBTC, self).__init__(feature_left, feature_right, N, "corr")

    def _load_internal(self, instrument, start_index, end_index, freq):
        res: pd.Series = super(CorrBTC, self)._load_internal(instrument, start_index, end_index, freq)
...
class CorrETH(PairRollingETH):
    ...
    def __init__(self, feature_left, feature_right, N):
        super(CorrETH, self).__init__(feature_left, feature_right, N, "corr")

    def _load_internal(self, instrument, start_index, end_index, freq):
        res: pd.Series = super(CorrETH, self)._load_internal(instrument, start_index, end_index, freq)
...
class CovBTC(PairRollingBTC):
    ...
    def __init__(self, feature_left, feature_right, N):
        ...
        super(CovBTC, self).__init__(feature_left, feature_right, N, "cov")
class CovETH(PairRollingETH):
    """Rolling Covariance
    ...
    def __init__(self, feature_left, feature_right, N):
        super(CovETH, self).__init__(feature_left, feature_right, N, "cov")
